...
export const Login = () => {
    ...
    const isLogin = useSelector<AppRootReducerType, boolean>((state) => state.auth.isLogin)
    const error = useSelector<AppRootReducerType, string | null>((state) => state.app.request.error)
